...
def pushM(item):
  pushMASMarray= ['@'+item,'D=M',"@SP",'A=M','M=D','@SP','M=M+1']
...
#print(os.getcwd())
#ASMFileName = str(os.path.dirname(daRealpath))
#print(ASMFileName)
#print(ASMFileName.find("StaticsTest")) # -1 means it didn't find the value
ASMFileName = str(os.getcwd())
print( ASMFileName.rpartition("/"))
ASMFileName = ASMFileName.rpartition("/")[2]
print(ASMFileName)
#print(os.getcwd())
#if(ASMFileName.find("StaticsTest") != (-1)):
    # then we are in StaticsTest
