...
def addASM():
  addASMarray= ["@SP",'A=M-1','D=M','@SP','A=M','D=D+M','@SP','A=M-1','M=D','@SP','M=M-1']
  printarray(addASMarray)
  
  return

def subASM():
  subASMarray= ["@SP",'A=M-1','D=M','@SP','A=M','D=D-M','@SP','A=M-1','M=D','@SP','M=M-1']
  printarray(subASMarray)
  
  return

def negASM():
  negASMarray= ["@SP",'A=M','D=-M','@SP','A=M','M=D','@SP','M=M-1']
