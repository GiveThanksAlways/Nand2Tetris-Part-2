...
This module provides classes for managing symbol tables during compilation,
including support for class-level and method-level scopes using linked lists.
"""
...
class LinkedList:
    ...
    def traverse(self, key: str, identifier: str) -> Optional[Any]:
        """
        Search for a value by key and identifier name.
        ...
        current = self.first_node
        while current is not None:
            entry_name = current.get_hash_table()['name']
...
class SymbolTable:
    ...
    Manages both class-level and method-level symbol tables,
    tracking variables, arguments, fields, and static variables.
    """

    def __init__(self) -> None:
        """Initialize empty class and method symbol tables."""
    ...
    def var_count(self, kind: str) -> int:
        ...
        Returns:
            The count of variables of the specified kind.
        """
        if kind == 'var':
    ...
    def add_id(self, name: str, symbol_type: str, kind: str) -> Union[int, str, None]:
        """
        Add a new identifier and return its index.
        ...
        Returns:
            The index assigned to this identifier.
        """
        if kind == 'var':
    ...
    def define(self, name: str, symbol_type: str, kind: str) -> None:
        """
        Define a new class-level symbol.
    ...
    def define_method(self, name: str, symbol_type: str, kind: str) -> None:
        """
        Define a new method-level symbol.
    ...
    def get_kind(self, identifier: str) -> Optional[str]:
        ...
        Returns:
            The segment kind ('local', 'argument', 'static', 'this') or None.
        """
    ...
    def get_id(self, identifier: str) -> Optional[int]:
        """
        Get the index for an identifier.

        Args:
            identifier: The identifier name.

        Returns:
            The index of the identifier or None if not found.
        """
    ...
    def get_void(self, identifier: str) -> Optional[bool]:
        ...
        Args:
            identifier: The subroutine name.

        Returns:
            True if void, False otherwise, or None if not found.
        """
        result = self.method_symbol_table.traverse('void', identifier)
        if result is not None:
            return result
